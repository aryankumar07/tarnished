...
export default function Page() {
  ...
  return (
    <div className="flex justify-center items-center pt-8 md:p-8 w-full">
      <div className="relative w-full max-w-[900px] mx-auto overflow-hidden rounded-2xl p-1">
        <div className="absolute inset-0 z-10 pointer-events-none" style={overlayStyle} aria-hidden="true" />
        <div className="relative z-20 flex flex-col justify-center items-center rounded-xl" style={{ backgroundColor: 'var(--surface)' }}>
          <Header />
          <ChatBox />
        </div>
      </div>
